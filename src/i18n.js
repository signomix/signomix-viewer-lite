export const dictionary = {
  pl: {
    ...
    "form.key": "Podaj klucz API (zmiana konta)",
    "form.submit": "Zatwierdź",
    "form.cancel": "Anuluj",
    "form.account_title": "Twoje konto",
    "form.logout": "Wyloguj",
    "form.config_title": "Konfiguracja",
  ...
  en: {
    ...
    "form.key": "Enter API key (change account)",
    "form.submit": "Submit",
    "form.cancel": "Cancel",
    "form.account_title": "Your account",
    "form.logout": "Log out",
    "form.config_title": "Configuration",
